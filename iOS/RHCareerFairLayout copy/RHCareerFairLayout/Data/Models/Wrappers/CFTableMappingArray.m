...
- (id) initWithArray:(NSArray *) data{
    ...
    if(array){
        ...
        for(id obj in data){
            ...
            NSNumber* id = [[NSNumber alloc] initWithInteger: (int)[tableMappingData objectForKey:@"id"]];
            NSNumber* companyId = [[NSNumber alloc] initWithInteger: (int)[tableMappingData objectForKey:@"companyId"]];
            NSNumber* size = [[NSNumber alloc] initWithInteger: (int)[tableMappingData objectForKey:@"size"]];
