...
public class DataManager {
	...
	try {
	    PreparedStatement updateStatement = SQLManager.getConn("RHCareerFairLayout").prepareStatement(
	...
	try {
	    ResultSet r = SQLManager.getConn("RHCareerFairLayout").createStatement()
	...
	PreparedStatement checkDBExists = SQLManager.getConn("RHCareerFairLayout")
	...
	PreparedStatement insertVars = SQLManager.getConn(dbName).prepareStatement(
    ...
    public static Response updateTableMappings(String dbName, Sheet tableMappings, List<Company> companies)
    ...
    public static Response updateCategories(String dbName, List<Category> categories)
	    throws SQLException, ClassNotFoundException {

	PreparedStatement insertCategories = SQLManager.getConn(dbName).prepareStatement(
    ...
    public static Response updateCompanies(String dbName, List<Company> companies)
	    throws SQLException, ClassNotFoundException {

	PreparedStatement insertCompanies = SQLManager.getConn(dbName).prepareStatement(
    ...
    public static Response updateCategories_Companies(String dbName, List<Company> companies)
	    throws SQLException, ClassNotFoundException {

	PreparedStatement insertCompanies = SQLManager.getConn(dbName)
	...
	for (int i = 0; i < companies.getRows(); i++) {
	    ...
	    String[] majors = companies.getItem(i, 1, String.class) == null ? new String[] {}
		    : companies.getItem(i, 1, String.class).split(",");
	    String[] workAuths = companies.getItem(i, 2, String.class) == null ? new String[] {}
		    : companies.getItem(i, 2, String.class).split(",");
