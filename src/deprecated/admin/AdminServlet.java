...
public class AdminServlet extends Servlet {
    ...
    */
	...
	case "uploadData": {
	    ...
	    if (body.getString("year", null, null).success && body.getString("quarter", null, null).success) {
	...
	case "updateTableMappings": {
	    ...
	    TableArray mappings = new ObjectMapper().readValue(bodyData, TableArray.class);
