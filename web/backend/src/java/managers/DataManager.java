...
public class DataManager {
	...
	PreparedStatement checkDBExists = SQLManager.getConn()
		.prepareStatement("SELECT COUNT(*) AS DBCount FROM Terms WHERE year=? AND quarter=?;");
    ...
    public static Result updateTermVars(String dbName, Sheet termVars) throws SQLException, ClassNotFoundException {
    ...
    public static Result updateTableMappings(String dbName, Sheet tableMappings, List<Company> companies)
    ...
    public static Result updateCategories(String dbName, List<Category> categories)
	    throws SQLException, ClassNotFoundException {
    ...
    public static Result updateCategories_Companies(String dbName, List<Company> companies)
	    throws SQLException, ClassNotFoundException {
    ...
    public static Result updateCategoriesAndCompanies(String dbName, Sheet categories, Sheet companies)
	    throws SQLException, ClassNotFoundException {
	...
	for (int i = 0; i < companies.getRows(); i++) {
	    ...
	    String[] majors = companies.getItem(i, "companyMajor", String.class) == null ? new String[] {}
		    : companies.getItem(i, "companyMajor", String.class).split(",");

	    String[] workAuths = companies.getItem(i, "companyWorkAuth", String.class) == null ? new String[] {}
		    : companies.getItem(i, "companyWorkAuth", String.class).split(",");

	    String[] posTypes = companies.getItem(i, "companyPositionType", String.class) == null ? new String[] {}
		    : companies.getItem(i, "companyPositionType", String.class).split(",");

	    String description = companies.getItem(i, "companyDetailDescription", String.class).replace("\"", "");

	    String websiteLink = companies.getItem(i, "companyDetailWebsite-href", String.class).replace("\"", "");

	    String address = companies.getItem(i, "companyDetailAddress", String.class).replace("\"", "");
	    ...
	    Company newCompany = new Company((long) (i + 100), name, null, websiteLink, address);
	...
	Result updateCategories_CompaniesResponse = updateCategories_Companies(dbName, companyList);

	if (updateCategoriesResponse.isSuccess() && updateCompaniesResponse.isSuccess()
	...
	failed.put("updateCategories_CompaniesResponse", updateCategories_CompaniesResponse);
	return failed;
