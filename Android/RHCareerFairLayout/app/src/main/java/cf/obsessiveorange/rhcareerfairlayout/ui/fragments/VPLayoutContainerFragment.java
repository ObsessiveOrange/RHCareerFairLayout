...
import cf.obsessiveorange.rhcareerfairlayout.ui.views.LayoutView;

/**
 * Fragment for ViewPagerTabFragmentActivity.
 * ScrollView callbacks are handled by its parent fragment, not its parent activity.
 */
public class VPLayoutContainerFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        layoutView = new LayoutView(getActivity());
